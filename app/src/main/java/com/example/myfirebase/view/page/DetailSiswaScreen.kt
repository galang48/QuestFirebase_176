package com.example.myfirebase.view.page
...
import com.example.myfirebase.view.components.common.SiswaTopAppBar
import com.example.myfirebase.view.components.detail.BodyDetailDataSiswa
                ...
                onClick = {
                    if (uiState is StatusUIDetail.Success) {
                        uiState.satusiswa?.let {
                            navigateToEditItem(it.id.toInt())
                        }
                    }
                },
